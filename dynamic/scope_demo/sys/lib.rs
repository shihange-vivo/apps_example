...
//! C31-a/C31-d scope corpus (§17.2, §8.5): the second system DSO. The
...
//! DSO's own relocation (§8.1 non-interpose).
//!
//! C31-d lifecycle evidence: the constructor/destructor maintain plain data
